...
public class MateriaService implements IMateriaService {
	...
	public List<MateriaDto> listar() {
		...
		try {
			List<MateriaDto> materiaDto = this.mapper.map(materiaRepository.findAll(),
	...
	public List<MateriaDto> listarPorHorarioMinimo(int horaMinima) {
		...
		return this.mapper.map(materiaRepository.findByHoraMinima(horaMinima), new TypeToken<List<MateriaDto>>() {
		}.getType());
	...
	public List<MateriaDto> listarPorFrequencia(int frequencia) {
		...
		return this.mapper.map(materiaRepository.findByFrequencia(frequencia), new TypeToken<List<MateriaDto>>() {
		}.getType());
	}
}
