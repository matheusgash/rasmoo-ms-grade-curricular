...
public class MateriaDto extends RepresentationModel<MateriaDto> {
	...
	@Min(value = 34, message = "Permitido o minímo de 34 horas por matéria.")
	@Max(value = 120, message = "Permitido o máximo de 120 horas horas por matéria.")
	private int horas;

	@NotBlank(message = "Informe o código da matéria.")
	private String codigo;

	@Min(value = 1, message = "Permitido o minímo de 1 vez ao ano.")
